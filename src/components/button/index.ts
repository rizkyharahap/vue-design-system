...
export const buttonVariants = {
  default: {
    ...
    yellow: `bg-yellow-700 text-white hover:bg-yellow-800 focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800`,
  },
  outlined: {
    ...
    green: `border border-green-700 text-green-700 hover:bg-green-800 hover:text-white focus:ring-green-300 dark:border-green-500 dark:text-green-500 dark:hover:bg-green-500 dark:hover:text-white dark:focus:ring-green-800`,
    ...
    yellow: `border border-yellow-400 text-yellow-400 hover:bg-yellow-500 hover:text-white focus:ring-yellow-300 dark:border-yellow-300 dark:text-yellow-300 dark:hover:bg-yellow-400 dark:hover:text-white dark:focus:ring-yellow-900`,
  },
};
export type ButtonVariants = keyof typeof buttonVariants;
export type ButtonColors = keyof typeof buttonVariants.default;
